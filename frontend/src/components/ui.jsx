...
export function Input({
  ...
  return (
    <label className="block">
      ...
      <input
        type={type}
        className={`w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100 ${
...
export function Select({ label, options, error, className = '', ...props }) {
  return (
    <label className="block">
      ...
      <select
        className={`w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-slate-900 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100 ${
          error ? 'border-red-300' : 'border-slate-200'
        } ${className}`}
        {...props}
      >
