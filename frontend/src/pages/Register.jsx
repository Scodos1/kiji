    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f8fafc] px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">Free to use. Start in 2 minutes.</p>
        </div>

        <form onSubmit={onSubmit} className="space-y-4 rounded-lg border border-slate-100 bg-white p-6 shadow-sm">
          <Input
            label="Your name"
            value={name}
